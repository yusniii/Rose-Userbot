...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("**EH TOT!!**")
    sleep(1)
    await typew.edit("**JANGAN SOK JAGOAN DAH LU**")
    sleep(1)
    await typew.edit("**MUKA GA ADA BENTUKAN AJA**")
    sleep(1)
...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("**KO LU GOBLOK BANGET ASU**")
    sleep(1)
    await typew.edit("**OTAK LU TUH SUNTIK PAKE GANJA**")
    sleep(1)
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("**HEH BABI!!**")
    sleep(1)
    await typew.edit("**MUKA KEK BABI**")
    sleep(1)
    ...
    await typew.edit("**MAKANYA JANGAN SANGEAN MULU**")
    sleep(1)
    await typew.edit("**KONTOL LU AJA MASIH JAMURAN**")
    sleep(1)
    await typew.edit("**EHHH SANGE NYA MAU DAPAT YANG CANTIK**")
    sleep(1)
    await typew.edit("**HAHAHAHA**")
